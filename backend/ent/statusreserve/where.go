...
func ID(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func IDLT(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusName(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameEQ(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatusName), v))
	})
}
...
func StatusNameNEQ(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameIn(vs ...string) predicate.StatusReserve {
...
func StatusNameNotIn(vs ...string) predicate.StatusReserve {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNameGT(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameGTE(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameLT(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameLTE(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameContains(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameHasPrefix(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameHasSuffix(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameEqualFold(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func StatusNameContainsFold(v string) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func HasReserves() predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
...
func HasReservesWith(preds ...predicate.ReserveRoom) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func And(predicates ...predicate.StatusReserve) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.StatusReserve) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.StatusReserve) predicate.StatusReserve {
	return predicate.StatusReserve(func(s *sql.Selector) {
		p(s.Not())
	})
}
